    ...
    return ( 
       ...
       <div className='container border-top mt-5'>
        ...
        <div className='mt-5 text-muted' style={{fontSize:"14px"}}>
          ...
          <div className='col '>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>NSE</a>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>BSE</a>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>MCX</a>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>Term & Conditions</a>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>Policies & procedures</a>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>Privacy policy</a>
            <a href='' className='text-muted mx-5' style={{textDecoration:"none"}}>Disclosure</a>
          </div>
       </div>
       </footer>
     );
